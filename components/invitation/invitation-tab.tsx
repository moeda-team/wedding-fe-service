                ...
                <RadioGroup className="">
                  <div className="flex  gap-3 ">
                    <RadioGroupItem
                      ...
                      id="option-one"
                    />
                    <Label htmlFor="option-one" className="grid grid-rows-2">
                      <p>Mempelai Pria - Mempelai Wanita</p>
                      <p className="text-font-gray-primary">
                        Nama mempelai pria akan ditampilkan disebelah kiri, dan
                        mempelai wanita disebelah kanan
                      </p>
                    </Label>
                  </div>
                  <div className="flex gap-3">
                    <RadioGroupItem
                      ...
                      id="option-two"
                    />
                    <Label htmlFor="option-two" className="grid grid-rows-2">
                      <p>Mempelai Wanita - Mempelai Pria</p>
                      <p className="text-font-gray-primary">
                        Nama mempelai wanita akan ditampilkan disebelah kiri,
                        dan mempelai pria disebelah kanan
                      </p>
                    </Label>
                  </div>
                </RadioGroup>
